...
def show_help(option):
    helps = {
        "1": "Generate an MD5 hash of your input with a random salt.",
        "2": "Generate a SHA-1 hash of your input with a random salt.",
        "3": "Generate a SHA-224 hash of your input with a random salt.",
        "4": "Generate a SHA-256 hash of your input with a random salt.",
        "5": "Generate a SHA-384 hash of your input with a random salt.",
        "6": "Generate a SHA-512 hash of your input with a random salt.",
        "7": "Generate a SHA3-256 hash of your input with a random salt.",
        "8": "Generate a BLAKE2b hash of your input with a random salt.",
        "9": "Generate a BLAKE2s hash of your input with a random salt.",
        "10": "Generate a CRC32 checksum of your input with a random salt.",
        "11": "Generate an NTLM (Windows NT) hash of your input (no salt).",
        "12": "Generate an HMAC (SHA-256) for your input using a random key.",
        "13": "Generate a PBKDF2 hash (SHA-256) of your input with a random salt.",
        "14": "Generate a Scrypt hash of your input with a random salt.",
        "15": "Encode any text to Base64 format.",
        "16": "Decode Base64-encoded text to its original form.",
        "17": "Check the strength of your input password (Very Weak to Very Strong).",
        "18": "Generate a random password of a length you choose.",
        "19": "Calculate the SHA-256 hash of a file you specify.",
        "20": "Encrypt your input using AES-256-CBC. Shows the key and IV.",
        "21": "Decrypt AES-256-CBC encrypted data. Requires key, IV, and ciphertext in hex.",
        "22": "Encrypt your input using DES (demo: uses AES-256-CBC). Shows the key and IV.",
        "23": "Decrypt DES-encrypted data (demo: uses AES-256-CBC). Requires key, IV, and ciphertext in hex.",
        "24": "Encrypt your input using Triple DES (demo: uses AES-256-CBC). Shows the key and IV.",
        "25": "Decrypt Triple DES-encrypted data (demo: uses AES-256-CBC). Requires key, IV, and ciphertext in hex.",
        "26": "Encrypt your input using ChaCha20 (demo: uses AES-256-CBC). Shows the key and IV.",
        "27": "Decrypt ChaCha20-encrypted data (demo: uses AES-256-CBC). Requires key, IV, and ciphertext in hex.",
        "28": "Encrypt your input using Fernet (demo: uses AES-256-CBC). Shows the key and IV.",
        "29": "Decrypt Fernet-encrypted data (demo: uses AES-256-CBC). Requires key, IV, and ciphertext in hex.",
        "30": "Encrypt your input using RSA (demo: uses AES-256-CBC). Shows the key and IV.",
        "31": "Decrypt RSA-encrypted data (demo: uses AES-256-CBC). Requires key, IV, and ciphertext in hex.",
        "32": "Encrypt your input using ECC (demo: uses AES-256-CBC). Shows the key and IV.",
        "33": "Decrypt ECC-encrypted data (demo: uses AES-256-CBC). Requires key, IV, and ciphertext in hex.",
        "34": "Exit the program.",
    }
